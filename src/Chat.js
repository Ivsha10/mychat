...
const Chat = ({ accessToken, currentUser, setCurrentUser, user, setAccessToken }) => {
    ...
    const fetchUsers = async () =>{
        try {
            const response = await fetch('http://131.239.186.178:3500/getusers', {credentials: 'same-origin', headers: {
    ...
    const sendMessage = async ()=> {
        ...
        try {
            const response = await fetch('http://131.239.186.178:3500/chat', chatConfig);
    ...
    const getAllChats = async ()=> {
        ...
        try {
            const response = await fetch('http://131.239.186.178:3500/chat/getall', chatConfig);
            const data = await response.json();
            console.log(data);
            setUserChats(data);
        } catch (err) {
    ...
    const handleRefresh = async ()=> {
        try {
            const response = await fetch('http://131.239.186.178:3500/refresh',{headers:{
                'Access-Control-Allow-Credentials':true
            }, credentials: 'include'});
            const data = await response.json();
            console.log(data);
    ...
    const handleLogout = async ()=>{
        const response = await fetch('http://131.239.186.178:3500/logout');
